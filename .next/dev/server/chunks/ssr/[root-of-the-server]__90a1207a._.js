...
"[project]/pages/auth/resetPassword.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ResetPassword = ()=>{
    ...
    const { mutate, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$mutation$2f$auth$2e$mutation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useResetPassword"])();
    ...
    const handleLogin = ()=>{
        ...
        mutate(payload, {
            onSuccess: ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Password has been successfully changed!");
                router.push('/login');
            },
            onError: (error)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error?.message || "Failed to change password, please try again.");
            }
        });
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90a1207a._.js.map