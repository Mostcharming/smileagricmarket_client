...
"[project]/pages/auth/verifyOTP.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const VerifyOTP = ()=>{
    ...
    const { mutate: verifyMutate, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$mutation$2f$auth$2e$mutation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useVerifyOtp"])();
    const { mutate: resendMutate, isPending: isResending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$mutation$2f$auth$2e$mutation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRequestOtp"])();
    const maskPhone = (num)=>{
        const s = num.trim();
    ...
    const maskedPhone = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>phoneParam ? maskPhone(phoneParam) : "", [
        phoneParam
    ]);
    const handleVerify = ()=>{
        if (!phoneParam) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Missing phone number.");
            return;
        }
        if (!otp) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please enter the OTP.");
            return;
        }
        if (otp.length !== 6) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("OTP must be exactly 6 digits.");
            return;
        }
        const payload = {
        ...
        verifyMutate(payload, {
            onSuccess: (response)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("OTP verified.");
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$cookies$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCookie"])(response.data.token);
                router.push("/onboarding");
            },
            onError: (error)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error?.message || "Failed to verify OTP.");
            }
        });
    };
    const handleResend = ()=>{
        ...
        resendMutate({
            ...
            onError: (error)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error?.message || "Failed to resend OTP.");
            }
        });
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0fcd29e3._.js.map